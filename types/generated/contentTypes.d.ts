...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    presentatories: Schema.Attribute.Relation<
      'manyToMany',
      'api::presentatory.presentatory'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiCateringPageCateringPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    content: Schema.Attribute.DynamicZone<
      ['dynamic-zone.sliding-gallery', 'ui.button']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::catering-page.catering-page'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    input_gender: Schema.Attribute.Component<'controls.select', false> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    inputs: Schema.Attribute.Component<'controls.input-field', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    send_button: Schema.Attribute.Component<'ui.button', false> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiElectronicElectronic extends Struct.CollectionTypeSchema {
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    brandelWebSite: Schema.Attribute.Component<'shared.link', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    columns: Schema.Attribute.Component<'ui.footer-col', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    contactPersonCol: Schema.Attribute.Component<
      'ui.contact-service-person',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    impressum: Schema.Attribute.Component<'shared.link', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    privacy: Schema.Attribute.Component<'shared.link', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    content: Schema.Attribute.DynamicZone<
      ['ui.button', 'dynamic-zone.sliding-gallery']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiNavbarNavbar extends Struct.SingleTypeSchema {
  ...
  attributes: {
    catering: Schema.Attribute.Component<'shared.link', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    gallery: Schema.Attribute.Component<'shared.link', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    home: Schema.Attribute.Component<'shared.link', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    rental: Schema.Attribute.Component<'shared.link', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPresentatoryPresentatory
  extends Struct.CollectionTypeSchema {
  collectionName: 'presentatories';
  info: {
    displayName: 'Presentatory';
    pluralName: 'presentatories';
    singularName: 'presentatory';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiRentalPageRentalPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    content: Schema.Attribute.DynamicZone<
      ['ui.rental-card', 'dynamic-zone.sliding-gallery']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiSocialMediaSocialMedia extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isPhoneNumber: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    mode: Schema.Attribute.Enumeration<['svg', 'css']>;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::catering-page.catering-page': ApiCateringPageCateringPage;
      ...
      'api::presentatory.presentatory': ApiPresentatoryPresentatory;
